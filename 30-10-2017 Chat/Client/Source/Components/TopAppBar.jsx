...
export default class TopAppBar extends React.Component
{
    ...
    {
        return (
            <div style={{height:'7%',  display:'flex', flexDirection:'row', justifyContent:'center', alignItems:"left", background:"linear-gradient(to right, black, blue, royalblue, purple, fuchsia, violet, pink)"}}>
