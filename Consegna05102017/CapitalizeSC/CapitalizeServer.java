        ...
        public void run() {
            try {
                ...
                while (true) {
                    ...
                    myLog("client#" + clientNumber + "send: " + input); //log che scrive il messaggio inviato dal client
                    ...
                    myLog(input.toUpperCase() + " sent to client#" + clientNumber); //log che scrive il messaggio che rimanda indietro il server
                }
            } catch (IOException e) {
